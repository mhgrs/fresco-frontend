export default function TerminosContenido() {
  return (
    <div className="prose prose-sm max-w-none text-gray-600 space-y-6">
      ...
      <section>
        ...
        <p>Puedes cancelar tu suscripción en cualquier momento desde el portal de tu cuenta. Al cancelar, tu plan se reducirá automáticamente al plan Gratis. Tus datos serán conservados durante 1 año calendario desde la última actividad de la cuenta, luego de los cuales podrán ser eliminados definitivamente.</p>
      </section>
      <section>
