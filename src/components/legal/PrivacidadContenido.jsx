export default function PrivacidadContenido() {
  return (
    <div className="prose prose-sm max-w-none text-gray-600 space-y-6">
      ...
      <section>
        ...
        <p>Tus datos se conservan mientras tengas una cuenta activa. Tras la eliminación o inactividad prolongada (más de 1 año), los datos serán eliminados definitivamente, salvo obligación legal de retención.</p>
      </section>
      <section>
