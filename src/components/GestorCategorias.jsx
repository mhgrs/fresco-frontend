              ...
              {categorias.map(cat => (
                <tr key={cat.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-center flex justify-center space-x-4">
                    ...
                    <button onClick={() => setConfirmarEliminar({ visible: true, id: cat.id, nombre: cat.nombre })} title="Eliminar" className="text-red-500 hover:text-red-700 transition-transform hover:scale-110">
