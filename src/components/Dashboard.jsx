      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        {!submenuActivo ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 relative z-10">
            ...
            {isBodega    && <ModuleCard to="/inventario"          titulo="Catálogo e Inventario" descripcion="Agrega productos, precios y categorías." icono={IconoInventario} />}
            ...
            {isAdmin     && <ModuleCard to="/configuracion"       titulo="Administración"        descripcion="Gestiona usuarios y configuración."    icono={IconoAdmin} />}
          </div>
          ...
          <div className="animate-fade-in">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 relative z-10">
              ...
              {isCajero && <ModuleCard to="/cierre-caja" titulo="Cierre de Caja" descripcion="Cuadratura y reporte de turno (Z)."        icono={IconoCierre} />}
            </div>
          </div>
          ...
          <div className="animate-fade-in">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 relative z-10">
              {isSupervisor && <ModuleCard to="/reportes"      titulo="Reportes del Negocio" descripcion="Estadísticas, ventas e inventario." icono={IconoReportes} />}
              {isAdmin      && <ModuleCard to="/configuracion" titulo="Equipo"               descripcion="Gestiona usuarios y permisos."      icono={IconoEquipo} />}
            </div>
          </div>
        ) : null}
      </div>
